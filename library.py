...
class Library: 
    ...
    def save_to_pickle(self, library):
...
def main():
    ...
    try:
        ...
        main()
            ...
            library:Library.save_to_pickle(library)
    ...
    if database_menu_choose == "2":
        ...
        try:
            ...
            library.save_to_pickle(library)
...
def goto_customer_menu():
    ...
    if customer_menu_choose == "1":
        ...
        try:
            ...
            mail_check = library.isValid_Email(email_of_customer)
            if mail_check is False:
                raise InValidEmail()
        ...
        except InValidEmail as error_message:
            print(visual_space)
            print("You enter InValid E-mail Address.")
            goto_customer_menu()
            ...
            print(visual_space)
            print("First name or Last name cannot be a digits.")
            goto_customer_menu()
    ...
    if customer_menu_choose == "5":
        ...
        try:
            ...
            if customer_list_choose == "1":
                print(visual_space)
                print(visual_customers_full)
                customer_id = int(input("| Enter Customer ID to get Customer Information: "))
                if customer_id not in customers_list:
                    raise CustomerNotExist()
...
def goto_book_menu():
    ...
    if books_menu_choose == "1":
        ...
        try:
            ...
            id_of_book = int(input("| Please enter ID of Book: "))
            ...
            print(visual_space)
            print("New book is been created successfuly!")
            library.save_to_pickle(library)
            goto_book_menu()    
            
        except BookIDUsed as error_message:
            print(visual_space)
            print("You cannot use this ID for Book, This ID is Used.")
            goto_book_menu()
    ...
    if books_menu_choose == "2":
        ...
        try:
            ...
            if len(book_list) == 0:
                print(visual_space)
                print("You doesnt have books in DB for display.")
                goto_book_menu()
            print(visual_space)
            ...
            if book_deleted == True:
                print(visual_space)
                print("The Book deleted successfuly")
                library.save_to_pickle(library)
                goto_book_menu()
            else:
                print(visual_space)
                print("Book not exist in the DB.")
                goto_book_menu()
                
        except BookIDUsed as error_message:
            print(visual_space)
            print("You cannot delete this Book, This Book ID is Loaned now.")
            goto_book_menu()
    ...
    if books_menu_choose == "3":
            ...
            if book_find_choose == "1":
                ...
                try:
                    ...
                    if len(books_list) == 0:
                        print(visual_space)
                        print("You not have books in DB.")
                        goto_book_menu()
                    print(visual_space)
                    print(visual_books_full)
                    book_id = int(input("| Enter ID to get information about the book: "))
                ...
                except BookNotExist as error_message:
                    print(visual_space)
            ...
            if book_find_choose == "3":
                ...
                try:
                    ...
                    print(visual_space)
                    print("You not have books in the DataBase.")
                    goto_book_menu()  
        ...
        try:
            ...
            if books_list_choose == "1":
                ...
                try:
                    ...
                    print(visual_space)
                    print("The choosed book not exist.")
                    goto_book_menu()  
    ...
    if loan_menu_choose == "1":
        ...
        try:
            ...
            if int(book_id) in loan_book:
                raise LoanedBook()
            if int(book_id) not in book_list:
                raise BookNotExist()
            print(visual_space)
            print(visual_creating_loan)
            print(f"| Choosed Customer:", customer.get_customer_half_info())
